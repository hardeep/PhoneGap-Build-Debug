...
After logging in navigate to https://build.phonegap.com/apps, and click the application you wish to enable debug on. 
...
Walking through this demonstration will enable you to get a better understanding of the :

You may download this sample application "Hello Debugging World" from:
{{GITHUB ACCOUNT}}

1. Next create a new application on phonegap build with the contents of "Hello Debugging World"; for instructions on how to the former visit http://{{link}}
